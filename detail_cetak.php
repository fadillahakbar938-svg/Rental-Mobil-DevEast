			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Rental Mobil DevEast</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center"><h2>DevEast Corporation</h2></td>
					</tr>
					<tr>
						<td class="text-center"> Jl. Pendidikan No.15, Cibiru Wetan, Cileunyi, Bandung, Jawa Barat 40625 </td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
